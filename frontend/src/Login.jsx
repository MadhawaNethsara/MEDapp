  ...
  const handleLogin = () => {
    ...
    return(
        ...
        <div className="flex flex-col item-center justify-center p-20 gap-8 bg-white/75 rounded-2xl">
          ...
          <button className="px-10 py-2 text-2xl rounded-md bg-gradient-to-tr from-green-400 to-blue-500 hover:to-pink-500 hover:to-yellow-500 text-white" onClick={handleLogin}>Login</button>
