      ...
      <div className="flex flex-col items-center justify-center w-full px-4">
        ...
        <div className="w-full max-w-md bg-[#222]/75 rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="flex flex-col space-y-4">
            <button className="w-full py-3 bg-gradient-to-tr from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white rounded-lg shadow-md transition-all duration-300 text-lg">
              🧑‍🎓 Register Students
            </button>
